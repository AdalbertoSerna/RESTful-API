...
if ($mname==NULL || $mname=='')//missing manufacturer id
{
...
$ch=curl_init("https://ec2-3-144-173-177.us-east-2.compute.amazonaws.com/api/query_manuf_by_name");
$data="mname=".$mname;
...
if($data[0] != 'Status: ERROR'){
    ...
    header('HTTP/1.1 200 OK');
    $output[]='Status: ERROR';
    $output[]='MSG: Manufacturer already exist!.';
    $output[]='Action: none';
    $responseData=json_encode($output);
    echo $responseData;
    die();	
